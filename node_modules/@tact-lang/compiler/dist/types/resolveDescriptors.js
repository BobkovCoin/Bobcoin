        ...
        if (isGetter) {
            for (const arg of args) {
                if ((0, isRuntimeType_1.isRuntimeType)(arg.type)) {
                    (0, ast_1.throwError)((0, types_1.printTypeRef)(arg.type) + ' is a runtime-only type and can\'t be used as a getter argument', arg.ref);
                }
            }
            if ((0, isRuntimeType_1.isRuntimeType)(returns)) {
                (0, ast_1.throwError)((0, types_1.printTypeRef)(returns) + ' is a runtime-only type and can\'t be used as getter return type', a.ref);
            }
        }
        // Register function
        return {
    ...
    function resolveInitFunction(ast) {
        ...
        for (const a of args) {
            if ((0, isRuntimeType_1.isRuntimeType)(a.type)) {
                (0, ast_1.throwError)((0, types_1.printTypeRef)(a.type) + ' is a runtime-only type and can\'t be used as a init function argument', a.ref);
            }
        }
        return {
            args,
