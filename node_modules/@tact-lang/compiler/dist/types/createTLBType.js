...
function createTLBType(name, args, kind, knownHeader) {
    ...
    if (kind === 'struct') {
        ...
        const op = knownHeader !== null ? knownHeader : (0, core_1.beginCell)().storeBuffer((0, crypto_1.sha256_sync)(base)).endCell().beginParse().loadUint(32);
        const opText = (0, core_1.beginCell)().storeUint(op, 32).endCell().beginParse().loadBuffer(4).toString('hex');
