...
async function run(args) {
    // Load config
    const resolvedPath = path_1.default.resolve(args.configPath);
    ...
    // Compile 
    let success = true;
    const project = (0, createNodeFileSystem_1.createNodeFileSystem)(rootPath, false);
    ...
    for (const config of projects) {
        ...
        const built = await (0, build_1.build)({ config, project, stdlib, logger: logger_1.consoleLogger });
