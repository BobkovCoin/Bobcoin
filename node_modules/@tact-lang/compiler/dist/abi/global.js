...
exports.GlobalFunctions = {
    ...
    pow: {
        ...
        generate: (ctx, args, resolved, ref) => {
            ...
            const a = (0, resolveConstantValue_1.resolveConstantValue)({ kind: 'ref', name: 'Int', optional: false }, resolved[0], ctx.ctx);
            const b = (0, resolveConstantValue_1.resolveConstantValue)({ kind: 'ref', name: 'Int', optional: false }, resolved[1], ctx.ctx);
