...
function dictValueParserSource() {
    return {
        serialize: (src, buidler) => {
            buidler.storeRef((0, core_1.beginCell)().store(storeSource(src)).endCell());
        },
        parse: (src) => {
...
async function Empty_init() {
    ...
    const __system = core_1.Cell.fromBase64('');
