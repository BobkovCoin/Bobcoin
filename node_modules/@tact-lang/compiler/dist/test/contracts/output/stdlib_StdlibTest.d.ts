...
export declare class StdlibTest implements Contract {
    ...
    getSliceEmpty(provider: ContractProvider, sc: Cell): Promise<boolean>;
    getSliceBits(provider: ContractProvider, sc: Cell): Promise<bigint>;
    getSliceRefs(provider: ContractProvider, sc: Cell): Promise<bigint>;
}
